// import HeroBlock from "./hero-block.jsx";
              ...
              >
                <div className="bg-white rounded-lg p-4 shadow-lg">
                  ...
                  <p className="mt-4 text-sm text-gray-600">
                    Navigation button changed, also minor fix to the width of
                    the sidebar
                  </p>
                  ...
                  <ul className="text-sm space-y-2">
                    <li className="flex items-center justify-between">
                      ...
                      <span className="text-gray-500">
                        369c6d6 Nicole Sayd | Jan 16, 13:16
                      </span>
                    </li>
                    <li className="flex items-center justify-between">
                      <span>dev: flattened layout depth</span>
                      <span className="text-gray-500">
                        369c6d6 Nicole Sayd | Jan 15, 18:05
                      </span>
                    </li>
                    <li className="flex items-center justify-between">
                      <span>chore: rename board file and import</span>
                      <span className="text-gray-500">
                        369c6d6 Nicole Sayd | Jan 14, 23:34
                      </span>
                    </li>
                  </ul>
                </div>
                ...
                <div className="bg-white rounded-lg p-4 shadow-lg">
                  <div className="bg-gray-100 rounded-lg p-4 text-center">
                    ...
                    <p className="text-sm text-gray-600 mt-2">
                      Securely store and manage your finances with our cloud
                      solution
                    </p>
