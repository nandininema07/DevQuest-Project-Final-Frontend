...
function LoginExpert() {
  ...
  axios.defaults.withCredentials = true
    const handleSubmit = (e) => {
        ...
        axios.post('http://localhost:3001/ExpertLogin',{username, password})
      ...
      <div className="flex w-full h-screen bg-white">
        ...
        <div className="w-1/2 flex flex-col justify-center items-center font-istok relative">
          ...
          <div className="w-4/5 bg-white shadow-xl p-8 rounded-lg">
            ...
            <div className='mb-3'>
              <button onClick={() => navigate('/login_user')} className='border rounded-lg py-2 px-4 mr-5 border-[#B5C18E] text-[#B5C18E]'>Login as a User</button>
