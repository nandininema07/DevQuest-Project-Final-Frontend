      ...
      <div className="flex w-full h-screen bg-white">
        ...
        <div className="w-1/2 flex flex-col justify-center items-center font-istok relative">
          ...
          <div className="w-4/5 bg-white shadow-xl p-8 rounded-lg">
            ...
            <div className='mb-3'>
              <button onClick={() => navigate('/register_user')} className='border rounded-lg py-2 px-4 mr-5 bg-[#B5C18E]'>Register as a User</button>
              <button onClick={() => navigate('/register_expert')} className='border rounded-lg py-2 px-4 border-[#B5C18E] text-[#B5C18E]'>Register as an Expert</button>
            </div>
            ...
            <div className="text-center mt-3">
              <p className="text-lg font-istok">Already have an account? <span onClick={() => navigate('/login_user')} className="text-[#B5C18E] cursor-pointer">LOGIN</span></p>
            </div>
          </div>
        </div>
      </div>
